...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    widthA4: 'A4 纸张排版 (210mm × 297mm)',
    widthTooltip: '切换正文内容版宽 (720px / 880px / 1180px / 自适应 / A4 纸张)',
    insertPageBreak: '插入 A4 物理分页符',
    pageBreakBadge: 'A4 分页符 (Page Break)',
    printPdfA4Tooltip: '打印 / 导出 PDF（插件内将打开系统浏览器打印预览）',
    focusMode: '专注模式',
    focusModeOn: '专注',
    focusModeOff: '退出专注',
    focusModeTooltip: '专注模式 (纯净居中，隐藏目录大纲)',
    presentationMode: '演示模式',
    presentationModeTooltip: '投屏讲解：隐藏大纲与状态栏，空格/方向键按章节翻页，Esc 退出',
    exitPresentation: '退出演示',
    presentationHudHint: '空格/↓ 下一节 · ↑ 上一节 · Esc 退出',
    autoScroll: '自动滚屏',
    ...
    outlineModeList: '列表',
    outlineModeTree: '树形',
    outlineModeListTooltip: '扁平缩进列表模式',
    outlineModeTreeTooltip: '可折叠树形结构模式',
    outlineExpand: '展开子章节',
    outlineCollapse: '折叠子章节',
    scrollSync: '双向滚动同步',
  ...
  'en-US': {
    ...
    widthFull: 'Fluid (Max)',
    widthA4: 'A4 Paper (210mm × 297mm)',
    widthTooltip: 'Cycle content width (720px / 880px / 1180px / Fluid / A4 Paper)',
    insertPageBreak: 'Insert A4 Page Break',
    pageBreakBadge: 'A4 Page Break',
    printPdfA4Tooltip: 'Print / Export PDF (opens system browser print preview in the extension)',
    focusMode: 'Focus',
    focusModeOn: 'Focus',
    focusModeOff: 'Exit Focus',
    focusModeTooltip: 'Focus mode (distraction-free, hides outline)',
    presentationMode: 'Present',
    presentationModeTooltip: 'Presentation mode: hide outline/status, Space/arrows for sections, Esc to exit',
    exitPresentation: 'Exit presentation',
    presentationHudHint: 'Space/↓ next · ↑ prev · Esc exit',
    ...
    outlineModeList: 'List',
    outlineModeTree: 'Tree',
    outlineModeListTooltip: 'Flat indented list mode',
    outlineModeTreeTooltip: 'Collapsible tree structure mode',
