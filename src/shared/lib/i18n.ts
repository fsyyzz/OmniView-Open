...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    openInNativeEditor: '在 VS Code 原生编辑器中并排打开',
    openInNativeEditorHint: '在 VS Code 原生文本编辑器中并排编辑（无缝支持 GitHub Copilot、AI 智能补全/对话、GitLens 与差异对比）',
    openSource: '打开源码',
    autoRefresh: '预览已实时同步',
  ...
  'en-US': {
    ...
    openInNativeEditor: 'Open in VS Code Editor',
    openInNativeEditorHint: 'Open side-by-side in VS Code native editor (Seamlessly supports GitHub Copilot, AI Chat, GitLens & Diff)',
