...
export const INITIAL_FILES: FileItem[] = [
  {
    ...
    path: '/workspace/callouts-and-tasks.md',
    extension: 'md',
    size: 3200,
    lastModified: Date.now(),
    content: `# GitHub 风格 Callout 提醒块与交互式任务清单
...
`,
  ...
  {
    id: 'file-typst-resume',
    name: 'software-engineer-resume.typ',
    path: '/workspace/software-engineer-resume.typ',
    extension: 'typ',
    size: 2800,
    lastModified: Date.now(),
    content: `// ========== 全局配置 ==========
...
`,
  ...
  {
    id: 'file-excalidraw-architecture',
    name: 'architecture-sketch.excalidraw',
    path: '/workspace/architecture-sketch.excalidraw',
    ...
    content: JSON.stringify({
      ...
      elements: [
        ...
        {
          id: 'text-client-title',
          type: 'text',
          x: 80,
          y: 85,
          text: 'OmniView Webview Host\n(React 19 + Vite)',
          fontSize: 16,
          fontFamily: 1,
          textAlign: 'center',
        ...
        {
          id: 'text-engine-title',
          type: 'text',
          x: 380,
          y: 85,
          text: 'Excalidraw Engine\n(@excalidraw/utils)',
          fontSize: 16,
          fontFamily: 1,
          textAlign: 'center',
          verticalAlign: 'middle',
        ...
        {
          id: 'text-output-title',
          type: 'text',
          x: 700,
          y: 85,
          text: 'Interactive SVG / PNG\n(DOMPurify Sanitized)',
          fontSize: 16,
          fontFamily: 1,
          textAlign: 'center',
          verticalAlign: 'middle',
        ...
        },
        {
          ...
          opacity: 100,
          points: [[0, 0], [80, 0]],
          startBinding: { elementId: 'card-client', focus: 0, gap: 1 },
          endBinding: { elementId: 'card-engine', focus: 0, gap: 1 },
          endArrowhead: 'arrow',
          seed: 107,
          version: 1,
          versionNonce: 1,
        ...
        },
        {
          ...
          opacity: 100,
          points: [[0, 0], [80, 0]],
          startBinding: { elementId: 'card-engine', focus: 0, gap: 1 },
          endBinding: { elementId: 'card-output', focus: 0, gap: 1 },
          endArrowhead: 'arrow',
          seed: 108,
          version: 1,
          versionNonce: 1,
        ...
        },
        {
          ...
          x: 60,
          y: 220,
          text: '✨ Phase 1: 高保真只读渲染 + 视口缩放平移 + SVG/PNG/JSON 导出 + 双向分屏源码联动',
          fontSize: 14,
          fontFamily: 1,
          strokeColor: '#862e9c',
          seed: 109,
