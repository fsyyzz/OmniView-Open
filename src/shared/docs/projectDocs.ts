...
### FR-05: Typst 出版级现代排版工作室 (Typst Driver)
* **FR-05.1 (双向分屏编辑与实时排版)**：支持在左侧编写 Typst 源码，右侧毫秒级响应并即时生成高精度多页矢量排版。
* **FR-05.2 (多页出版与物理分页)**：支持 \`#set page\` 纸张与边距、\`#set document\` 标题/作者、\`#pagebreak()\` 强制切页与双面奇偶页装订线边距。
