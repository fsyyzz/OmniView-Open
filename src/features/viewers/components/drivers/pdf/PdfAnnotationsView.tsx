...
export const PdfAnnotationsView: React.FC<PdfAnnotationsViewProps> = ({
  ...
  if (annotations.length === 0) {
    return (
      <div className="p-4 text-center text-xs flex flex-col items-center gap-2.5" style={{ color: 'var(--ov-text-muted)' }}>
        <div
        ...
        <div className="space-y-1">
          <div className="font-medium" style={{ color: 'var(--ov-text)' }}>暂无高亮批注</div>
          <div className="text-[11px] max-w-[180px] leading-relaxed" style={{ color: 'var(--ov-text-muted)' }}>
  ...
  return (
    <div className="flex flex-col gap-2 p-1 text-xs select-none">
      {/* 顶部操作条 */}
      <div
        className="flex items-center justify-between px-1 py-1 text-[11px] pb-2 mb-1"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="flex items-center gap-1 px-1.5 py-0.5 rounded transition hover:bg-[var(--ov-surface-hover)] border"
            style={{
              backgroundColor: 'var(--ov-surface)',
          ...
          <button
            onClick={onClearAll}
            className="p-1 rounded transition hover:bg-rose-500/10 text-rose-500 hover:text-rose-600"
            title="清空所有批注"
          >
          ...
          return (
            <div
              ...
              className={`p-2 rounded-lg border transition ${cfg.bg} ${cfg.border} ${
                isCurrent ? 'ring-2 ring-[var(--ov-accent)] shadow-md' : ''
              }`}
            >
              {/* 头部元信息 */}
              <div className="flex items-center justify-between mb-1.5">
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="font-mono text-[10px] flex items-center gap-0.5 font-bold hover:underline"
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="p-0.5 rounded transition hover:bg-[var(--ov-surface-hover)]"
                  ...
                  <button
                    ...
                    className="p-0.5 rounded transition hover:bg-rose-500/10 text-rose-400 hover:text-rose-600"
                    title="删除此条批注"
                  >
                    <Trash2 className="w-3 h-3" />
                  </button>
              ...
              {/* 选中文本摘录 */}
              <div
                className="text-[11px] font-serif italic line-clamp-3 p-1.5 rounded border"
                style={{
                  backgroundColor: 'var(--ov-quote-bg, var(--ov-bg))',
              ...
              {editingId === ann.id ? (
                <div className="mt-2 space-y-1.5">
                  <textarea
                    ...
                    rows={2}
                    className="w-full rounded p-1 text-[11px] focus:outline-none resize-none"
                    style={{
                  ...
                  <div className="flex justify-end gap-1">
                    <button
                      ...
                      className="px-2 py-0.5 text-[10px] rounded transition hover:bg-[var(--ov-surface-hover)]"
                    ...
                    <button
                      ...
                      className="px-2 py-0.5 text-[10px] bg-blue-600 hover:bg-blue-500 text-white rounded font-medium transition"
                    >
                      保存
                    </button>
                  </div>
                ...
                <div className="mt-1.5 text-[11px] flex items-start gap-1" style={{ color: 'var(--ov-text)' }}>
                  <span className="shrink-0" style={{ color: 'var(--ov-text-muted)' }}>↳</span>
